...
function IntroPage(){
  ...
  return(
    <div className="w-full">
      <Header/>
      <div className='flex h-[80vh] md:max-h-96 bg-blue-500 py-20 px-5 '>
        <MainContainer>
      ...
      <div className='flex flex-col md:flex-row bg-black h-[15vh] align-center items-center justify-center'>
        <div className="text-white font-bold pb-5">
          Find me across the internet:
        </div>  
        <div className="flex w-full px-20 text-white justify-between">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM12.0606 11.6829L5.64722 6.2377L4.35278 7.7623L12.0731 14.3171L19.6544 7.75616L18.3456 6.24384L12.0606 11.6829Z" fill="rgba(255,255,255,1)"/></svg>
      ...
      <div className="py-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center py-5 px-10">
          <img className="py-3 w-11/12" src='images/Rectangle 2small.png'/>
