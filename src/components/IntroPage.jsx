...
function IntroPage(){
  ...
  return(
    <div className="w-full">
      <Header/>
      <div className='h-[85vh] md:max-h-96 bg-blue-500 py-20 px-5 space-y-10'>
        <MainContainer>
      ...
      <div className='flex flex-col md:flex-row bg-black w-100 h-24 align-center items-center justify-center space-x-10'>
        <div className="text-white font-bold">
          Find me across the internet:
        </div>  
        <div className="flex w-full -ml-0 text-white justify-between">
